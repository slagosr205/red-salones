    ...
    return (
        <GuestLayout>
            ...
            <div className="tw-mb-4 tw-text-sm tw-text-gray-600">
                <p className="tw-font-semibold">Registro de salon</p>
                <p>Tu cuenta quedara pendiente de aprobacion. Recibiras un correo cuando sea activada.</p>
            </div>

            <form onSubmit={submit}>
                <div>
                    <InputLabel htmlFor="name" value="Nombre del salon" />
