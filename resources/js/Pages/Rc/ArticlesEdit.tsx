...
export default function ArticlesEdit({ article, categories = [] }: { article: Article; categories?: string[] }) {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        post(route('rc.articles.update', article.id));
    };

    return (
        <AuthenticatedLayout header="Editar Artículo">
                        ...
                        <Stack spacing={2.5}>
                            ...
                            <Box>
                                <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                                    Imagen (dejar vacío para mantener la actual, max 2MB)
                                </Typography>
                                <input
                                    type="file"
